    ...
    def _split_generators(self, dl_manager):
        ...
        return [
            datasets.SplitGenerator(
                ...
                gen_kwargs={
                    "filepath": os.path.join(data_dir, "th_winogrande__few-shot.json"),
            ...
            datasets.SplitGenerator(
                ...
                # These kwargs will be passed to _generate_examples
                gen_kwargs={
                    "filepath": os.path.join(data_dir, "th_winogrande__validation.json"),
    ...
    def _generate_examples(self, filepath, split):
        ...
        with open(filepath, encoding="utf-8") as f:
            ...
            for id_, data in enumerate(json_data):
                ...
                # else:
                yield id_, {
                    "sentence": data["th_sentence"],
                    "option1": data["th_option1"],
                    "option2": data["th_option2"],
                    "answer": data["answer"],
                }
